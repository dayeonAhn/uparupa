...
<head>	
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/style/temp.css"> <!--재성 -->
</head>
<body>
    ...
    <div class="BookSearchContent">
        <div class="BookSearchListTop">
            ...
            <span class="dropdown-el">
                <!-- <input type="radio" name="sortType" value="accuracy" checked="checked" id="sort-relevance">
                <label for="sort-relevance">정확도순</label>
                <input type="radio" name="sortType" value="recency" id="sort-best">
                <label for="sort-best">최신순</label> -->
    ...
    <%-- document.addEventListener('DOMContentLoaded', function() {
        ...
        let isClicked = false;
             ...
             starIcon.addEventListener('click', function(e) {
                ...
                isClicked = !isClicked;
                if (isClicked) {
                    starIcon.src = '../resources/images/bookstar_on.png';
                } else {
                    starIcon.src = '../resources/images/bookstar_off.png';
                }
